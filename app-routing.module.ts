...
const routes: Routes = [
  ...
  {
    path: '',
    redirectTo: 'home', // Redirige a las pestañas por defecto
    pathMatch: 'full'
  },
  {
    path: 'register',
  ...
  {
    path: 'list', // Solo necesitas definir la ruta para cargar el módulo Tabs
  ...
  {
    path: 'deuda',
    loadChildren: () => import('./deuda/deuda.module').then( m => m.DeudaPageModule)
  },
  {
    path: 'solicitudes',
